...
from ..uniform import solve_uniform_grid_at_mu, solve_uniform_grid_fixed_filling
...
def _resolve_integration_handler(
    registry: dict[type[IntegrationMethod], IntegrationHandler],
    integration: IntegrationMethod,
) -> IntegrationHandler:
...
def integration_handler(integration: IntegrationMethod) -> IntegrationHandler:
    return _resolve_integration_handler(_HANDLERS, integration)
