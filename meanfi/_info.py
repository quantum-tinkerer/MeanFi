...
@dataclass(frozen=True)
class SimplexGridInfo:
    """Reserved metadata for future simplex-grid integration."""
...
class DensityMatrixResult:
    ...
    integration: object
    info: AdaptiveSimplexInfo | AdaptiveQuadratureInfo | UniformGridInfo | SimplexGridInfo
